...
#Rename Semi-weekly
final_data$PCR.frequency <- gsub("semiweekly", "semi-weekly", final_data$PCR.frequency)
combined_data$PCR.frequency <- gsub("semiweekly", "semi-weekly", combined_data$PCR.frequency)
...
df3$PCR.frequency <- factor(df3$PCR.frequency, levels = c("workday", "semi-weekly", "weekly", "monthly",
                                                                        "none"))
