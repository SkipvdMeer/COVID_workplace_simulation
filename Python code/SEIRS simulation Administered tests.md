```python
# This code uses the SEIRS simulation function to investigate the transmission of COVID-19 in the workplace to compare with
# tests with the sensitivity as stated in Stohr et al. (2021).
```
...
from sim_loops_altered_administered_test import *
```
...
final_df.to_csv(r'C:\Users\Quint\Documents\Documents\Master Behavioral Data Science\MasterThese\Data\Full_dataset_administered_test2.csv')

# Save as combined data as combined data as excel
combined_df.to_csv(r'C:\Users\Quint\Documents\Documents\Master Behavioral Data Science\MasterThese\Data\Combined_dataset_administered_test2.csv')
```
