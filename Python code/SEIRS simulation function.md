...
def simulation_covid(Network_size, Bubble_size, PCR_Frequency, R, Itterations):
    ...
    for i in range(Itterations):
            ...
            # Not realistic, but all networks have same % infected
    ...
    for j in range(len(Bubble_size)):
        ...
        for k in range(len(PCR_Frequency)):
            for l in range(len(R)):
                simulation_covid(Network_size[i], Bubble_size[j], PCR_Frequency[k], R[l], 50)
...
for i in range(len(Network_size)):
    for k in range(len(PCR_Frequency)):
        for l in range(len(R)):
            simulation_covid(Network_size[i], Network_size [i], PCR_Frequency[k], R[l], 50)
```
...
final_df.to_csv(r'C:\Users\Quint\Documents\Documents\Master Behavioral Data Science\MasterThese\Data\Full_Dataset_thesis_noBubble.csv')

# Save as combined data as combined data as excel
combined_df.to_csv(r'C:\Users\Quint\Documents\Documents\Master Behavioral Data Science\MasterThese\Data\Combined_Dataset_thesis_noBubble.csv')
```
