```python
# This code replicates the study of Chin et al. (2020) as accurately as possible
```
...
from sim_loops_altered_replication import *
```
...
def simulation_covid(Network_size, Bubble_size, PCR_Frequency, R, Itterations):
    ...
    for i in range(Itterations):
            ...
            TESTING_COMPLIANCE_RATE_SYMPTOMATIC                  = 1.0
...
for i in range(len(Network_size)):
    for k in range(len(PCR_Frequency)):
        for l in range(len(R)):
            simulation_covid(Network_size[i], Network_size [i], PCR_Frequency[k], R[l], 1000)
```
...
final_df.to_csv(r'C:\Users\Quint\Documents\Documents\Master Behavioral Data Science\MasterThese\Data\Replication_Full_Dataset_thesis.csv')

# Save as combined data as combined data as excel
combined_df.to_csv(r'C:\Users\Quint\Documents\Documents\Master Behavioral Data Science\MasterThese\Data\Replication_Combined_Dataset_thesis.csv')
```
